...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.build()
				.tags(new Tag("user", "User management"), tags())
				.apiInfo(apiInfo())
				.protocols(protocols())
...
//				.securityContexts(securityContexts());
	...
	private Tag[] tags() {
		...
		tags.add(new Tag("group", "Group management"));
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder()
				...
				.description("This is User/Group API Swagger Documentation")
				.termsOfServiceUrl("http://liuchunhua.com")
				.contact(new Contact("liuchunhua", "liuchunhua.com", "liuchunhua123@gmail.com"))
